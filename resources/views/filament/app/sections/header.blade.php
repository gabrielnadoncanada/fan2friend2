<header class="absolute top-0 w-full left-0 z-10 h-[85px]">
    <div class="border-b border-[#D6D6D6]  max-w-[1440px]  mx-auto flex items-center justify-between gap-x-[30px] py-[20px]">
        <div class="flex gap-x-[72px]">
                    ...
                    <g id="logo-main" transform="translate(-348.45 -326.66)">
                        <g id="Group_1" data-name="Group 1" transform="translate(421.597 337.766)">
                            ...
                            <path id="Path_10" data-name="Path 10"
                                  ...
                                  transform="translate(-790.515 -357.25)" fill="#0d0d0d"/>
                        </g>
            ...
            <form action="/search">
                <label>
                    <input type="text" name="q" placeholder="Cherchez une personnalité"
                           class="bg-[#F7F7F7] border-0 border-[#D6D6D6] text-almost-black rounded-full w-[275px] px-6 py-2">
                </label>
            </form>
        </div>
        <div class="ml-auto">
            <a href="#">CA</a>&nbsp;|&nbsp;<a href="#">FR</a>
        </div>
